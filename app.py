...
def processRequest(req):
    ...
    if req.get("result").get("action") == "yahooWeatherForecast":
        ...
        data = req
        res = makeWebhookResultForGetBmiChart(data)
    else:
        return {}
    return res
 
def makeWebhookResultForGetBmi(data):
    element1 = data.get("result").get("parameters").get("elementname")
    element2 = data.get("result").get("parameters").get("elementname")
